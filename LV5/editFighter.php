...
<html lang="en">
    ...
    <body class="row">
        ...
        <form class="container" action="./controller/db/UpdateFighter.php" method="post" enctype="multipart/form-data">
            ...
            <p class="from-group row">
                ...
                <input type="file" id="fimg" name="fimg" class="col-sm-10"/>
            </p>
            <p class="from-group row">
                <button type="submit" id="fsubmit" name="fsubmit" class="col-sm-12">SUBMIT</button>
            </p>
            <p class="from-group row">
                <input type="hidden" name="id" value="<?=$fighter_id?>"/>
                <button type="submit" formmethod="POST" formaction="./controller/db/Delete.php" id="btnDel" name="btnDel" class="col-sm-12">DELETE FIGHTER</button>
            </p>
        </form>
    </body>
</html>